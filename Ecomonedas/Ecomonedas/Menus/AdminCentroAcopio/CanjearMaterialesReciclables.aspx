                        ...
                        <div class="card-group card-group-toggle" data-toggle="buttons" style="width: 70%; margin: auto;">
                            ...
                            <div class="card text-white pap mb-3" style="max-width: 100%;">
                                ...
                                <div class="card-footer text-muted" style="text-align: center;">
                                    <asp:TextBox ID="txtCantidadPapel" Text="0" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="card text-white vid mb-3" style="max-width: 100%;">
                                ...
                                <div class="card-footer text-muted" style="text-align: center;">
                                    <asp:TextBox ID="txtCantidadVidrio" Text="0" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="card text-white pla mb-3" style="max-width: 100%;">
                                ...
                                <div class="card-footer text-muted" style="text-align: center;">
                                    <asp:TextBox ID="txtCantidadPlastico" Text="0" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="card text-white alu mb-3" style="max-width: 100%;">
                                ...
                                <div class="card-footer text-muted" style="text-align: center;">
                                    <asp:TextBox ID="txtCantidadAluminio" Text="0" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="card text-white limp mb-3" style="max-width: 100%;">
                                ...
                                <div class="card-footer text-muted" style="text-align: center;">
                                    <asp:TextBox ID="txtCantidadQuimicos" Text="0" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="card text-white tet mb-3" style="max-width: 100%;">
                                ...
                                <div class="card-footer text-muted" style="text-align: center;">
                                    <asp:TextBox ID="txtCantidadTetra" Text="0" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
